...
ABAP open source projects can register own namespaces. This repository lists all known ones and provides development and repair keys for the ABAP Cloud Developer Trial system.
